import { SamsUIButtonTheme } from "./Button";
import { SamsUIButtonGroupTheme } from "./ButtonGroup";

export const buttonTheme: SamsUIButtonTheme = {
...
export const buttonGroupTheme: SamsUIButtonGroupTheme = {
  base: "inline-flex",
  position: {
    none: "focus:ring-2",
    start: "rounded-r-none",
